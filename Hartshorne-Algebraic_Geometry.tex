...
\Page{32}
\Topic{Details in the proof of theorem 5.1 about the
...
\Page{40}
\Topic{Every localization of a Dedekind domain at a nonzero
...
\Page{44}
\Topic{The uniqueness of $\bar\varphi$ is clear by
  construction}
...
\Topic{Theorem 6.9 paragraph 2: why not use lemma 6.5 to
